...
function celsiusToFarenhite(_temp) {
    return _temp * (9 / 5) + 32;
}
;
let convertedToFarenhite = celsiusToFarenhite(78);
...
;
const percentageObtained = percentage(894, 1100);
...
function daysIntoWeeks(numbers) {
...
let amountOfTheBill = 25000;
let numberOfUnits = 200;
